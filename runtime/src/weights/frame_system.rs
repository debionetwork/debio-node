...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn set_storage(i: u32, ) -> Weight {
		(0_u64)
			...
			.saturating_add((1_037_000_u64).saturating_mul(i as Weight))
	...
	fn kill_storage(i: u32, ) -> Weight {
		(1_790_000_u64)
			...
			.saturating_add((683_000_u64).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i as Weight)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	fn kill_prefix(p: u32, ) -> Weight {
		(0_u64)
			// Standard Error: 2_000
			.saturating_add((999_000_u64).saturating_mul(p as Weight))
