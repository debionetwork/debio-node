...
pub struct Pallet<T: Config>(MenstrualSubscription<T>);

pub trait Config:
	ServicesConfig + LabsConfig + UserProfileConfig + OrdersConfig + MenstrualSubscriptionConfig
{
}

use frame_support::sp_runtime::traits::Hash;
use menstrual_subscription::Call;
