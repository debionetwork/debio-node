...
pub trait CertificationInterface<T: frame_system::Config> {
    ...
    fn create_certification(owner_id: &T::AccountId, certification: &Self::CertificationInfo) -> Result<Self::Certification, Self::Error>;
    fn update_certification(owner_id: &T::AccountId, certification_id: &Self::CertificationId, certification: &Self::CertificationInfo) -> Result<Self::Certification, Self::Error>;
