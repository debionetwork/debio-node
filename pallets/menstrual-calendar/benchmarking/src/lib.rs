...
pub struct Pallet<T: Config>(MenstrualCalendar<T>);

pub trait Config:
	ServicesConfig + LabsConfig + UserProfileConfig + OrdersConfig + MenstrualCalendarConfig
{
}

use frame_support::sp_runtime::traits::Hash;
use menstrual_calendar::Call;
