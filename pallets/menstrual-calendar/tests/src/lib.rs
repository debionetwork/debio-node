...
mod tests {
	...
	use traits_menstrual_calendar::{DnaSampleTracking, DnaSampleTrackingId};
	...
	fn reject_dna_sample_works() {
		<ExternalityBuilder>::default().existential_deposit(1).build().execute_with(|| {
			...
			let _dna_sample = MenstrualCalendar::dna_samples_by_lab_id(1).unwrap();

			assert_ok!(MenstrualCalendar::reject_dna_sample(
				Origin::signed(1),
				_dna_sample[0].clone(),
			...
			let _dna_sample_info =
				MenstrualCalendar::dna_sample_by_tracking_id(_dna_sample[0].clone()).unwrap();
	...
	fn cannot_reject_dna_sample_not_found() {
		<ExternalityBuilder>::default().existential_deposit(1).build().execute_with(|| {
			assert_noop!(
				MenstrualCalendar::reject_dna_sample(
					Origin::signed(1),
	...
	fn process_dna_sample_works() {
		<ExternalityBuilder>::default().existential_deposit(1).build().execute_with(|| {
			...
			assert_ok!(MenstrualCalendar::submit_test_result(
				Origin::signed(1),
				_dna_sample[0].clone(),
			...
			let _dna_test_result =
				MenstrualCalendar::dna_test_result_by_tracking_id(_dna_sample[0].clone()).unwrap();
			...
			assert_ok!(MenstrualCalendar::process_dna_sample(
				Origin::signed(1),
				_dna_sample[0].clone(),
	...
	fn cannot_process_dna_sample_works_not_found() {
		<ExternalityBuilder>::default().existential_deposit(1).build().execute_with(|| {
			assert_noop!(
				MenstrualCalendar::process_dna_sample(
					Origin::signed(1),
					DnaSampleTrackingId::from_vec("xxxxxxxxxxxxxxxxxxxxx".as_bytes().to_vec()),
					DnaSampleStatus::ResultReady
				),
	...
	fn cannot_submit_test_result_not_found() {
		<ExternalityBuilder>::default().existential_deposit(1).build().execute_with(|| {
			...
			assert_noop!(
				MenstrualCalendar::submit_test_result(
					Origin::signed(1),
					DnaSampleTrackingId::from_vec("xxxxxxxxxxxxxxxxxxxxx".as_bytes().to_vec()),
					DnaTestResultSubmission {
						comments: Some("DNA Test Result comments".as_bytes().to_vec()),
	...
	fn submit_independent_test_result_works() {
		<ExternalityBuilder>::default().existential_deposit(1).build().execute_with(|| {
			assert_ok!(MenstrualCalendar::submit_independent_test_result(
				Origin::signed(1),
				DnaTestResultSubmission {
					comments: Some("DNA Test Result comments".as_bytes().to_vec()),
					result_link: Some("DNA Test Result result_link".as_bytes().to_vec()),
			...
			let _dna_sample = MenstrualCalendar::dna_test_results_by_owner_id(1).unwrap();
	...
	fn cannot_submit_independent_test_result_link_not_found() {
		<ExternalityBuilder>::default().existential_deposit(1).build().execute_with(|| {
			assert_noop!(
				MenstrualCalendar::submit_independent_test_result(
					Origin::signed(1),
					DnaTestResultSubmission {
						comments: Some("DNA Test Result comments".as_bytes().to_vec()),
						result_link: None,
	...
	fn submit_data_bounty_details_works() {
		<ExternalityBuilder>::default().existential_deposit(1).build().execute_with(|| {
			assert_ok!(MenstrualCalendar::submit_data_bounty_details(
				Origin::signed(1),
