...
use traits_genetic_analyst_qualifications::{
    GeneticAnalystQualificationInfo as GeneticAnalystQualificationInfoT, GeneticAnalystQualificationOwner,
    GeneticAnalystQualificationsProvider,
};
...
impl<T, AccountId, Hash> GeneticAnalystQualificationInfoT<T> for GeneticAnalystQualification<AccountId, Hash>
where
...
pub mod pallet {
    ...
    use crate::interface::GeneticAnalystQualificationInterface;
    use crate::{GeneticAnalystQualification, GeneticAnalystQualificationInfo, GeneticAnalystQualificationOwner};
    ...
    pub type GeneticAnalystQualificationOf<T> = GeneticAnalystQualification<AccountIdOf<T>, HashOf<T>>;
...
impl<T: Config> GeneticAnalystQualificationInterface<T> for Pallet<T> {
    ...
    fn create_qualification(
        ...
        let owner_qualification_count =
            <Self as GeneticAnalystQualificationInterface<T>>::qualification_count_by_owner(owner_id);
