...
docker run -d --name=debio_substrate_service -v /etc/localtime:/etc/localtime:ro -p 0.0.0.0:9944:9944 --restart=always hub.theapps.dev/debio_substrate_service:latest --dev --alice --unsafe-ws-external
